...
function [of_rate,uvfluxs] = explicit2(TSP2D,shp,n_row,n_col,deltaT,s_dep,s_grid,man_area,dem,oflow,of_rate)
            ...
            if shp(x,y) ~= -9999
                for z = -1:0
                    ...
                    if xx <= n_row && yy <= n_col && shp(xx,yy) ~= -9999
                        uvfluxs(x,y,z+2) = overland2(TSP2D,dt,s_dep,s_grid,man_area,dem,oflow,x,y,xx,yy);
